...
test("sitemap includes exactly the expected public-route counts: 6 static + 107 Divya Desams + 1 book + 55 chapters + 1 Knowledge", () => {
  const entries = buildSitemapEntries();
  assert.equal(entries.length, 6 + 107 + 1 + 55 + 1);
});
