...
/**
 * Round 8: fourth slice of the full proper-noun pass -- Vishnu-avatar and
 * deity epithet names, this time anchored directly against the ALREADY
 * ESTABLISHED content/divya-desams corpus (not fresh Sanskrit-root
 * derivation) wherever that corpus already has a settled precedent:
 * Varaha->Varāha (23 macron vs 2 plain in Divya Desams), Vamana->Vāmana
 * (17 vs 0), Garuda->Garuḍa (16 vs 0), Surya->Sūrya (5 vs 0),
 * Prahlada->Prahlāda (7 vs 3). Kurma->Kūrma and Ganapati->Gaṇapati have no
 * Divya Desam precedent to check against but are well-documented standard
 * Sanskrit forms (Kūrma genuinely has a long ū; Gaṇapati a retroflex ṇ).
 *
 * Confirmed staying plain, also verified against Divya Desam precedent:
 * Narasimha (46 plain, 0 macron form there), Kanchipuram/Kanchi (0/3,
 * plain only), Indra and Chandra (both genuinely have no long vowel
 * regardless).
 *
