...
/**
 * Round 7: third slice of the full proper-noun pass -- place names and
 * sage/rishi names missing their standard long vowel(s) and/or retroflex
 * consonants, verified against genuine Sanskrit roots (same principle as
 * rounds 5-6). Note Dwaraka->Dwārakā here supersedes round 4's
 * consistency-only fix (which just picked the majority existing spelling,
 * "Dwaraka" over "Dwarka", without checking the genuine root) -- same
 * category of correction as round 6's Bheeshma->Bhīshma.
 *
...
const REPLACEMENTS: Record<string, string> = {
  Hastinapur: "Hastināpura",
  Mathura: "Mathurā",
  Dwaraka: "Dwārakā",
  Vrindavan: "Vrindāvana",
  Lanka: "Lankā",
  Panchavati: "Panchavaṭī",
  Mithila: "Mithilā",
  Panchala: "Pāñcāla",
  Gandhara: "Gandhāra",
  Himalayas: "Himālayas",
  Vaikuntham: "Vaikuṇṭham",
  Vaikuntha: "Vaikuṇṭha",
  Vasishta: "Vasishṭha",
  Durvasa: "Durvāsa",
  Kausika: "Kaushika",
  ...
  Valmiki: "Vālmīki",
  Yayati: "Yayāti",
  Ashtavakra: "Ashṭāvakra",
  Bharadwaja: "Bharadwāja",
  Yavakrida: "Yavakrīda",
};
